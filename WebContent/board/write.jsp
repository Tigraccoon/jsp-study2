...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col col-auto">
			<h2>글쓰기</h2><br>
			<form action="${path}/board_servlet/insert.do" name="form1" method="post" enctype="multipart/form-data">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input name="subject" id="subject" class="form-control"></td>
					</tr>
					<tr>
						<th><label for="content">본문</label></th>
						<td><textarea rows="5" cols="60" name="content" id="content" class="form-control"></textarea></td>
					</tr>
					<tr>
					...
					<tr>
						<th colspan="2"><input type="button" value="글쓰기" id="btnSave" class="btn btn-primary"></th>
					</tr>
				</table>
			</form>
		</div>
